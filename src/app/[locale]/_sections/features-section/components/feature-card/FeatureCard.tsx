...
const FeatureCard: FC<FeaturesSectionProps> = ({
  ...
  return (
    <div className="relative w-full h-full flex flex-col gap-y-4 p-8 border border-primary-600 rounded-lg overflow-hidden bg-box-pattern bg-no-repeat bg-center bg-cover">
